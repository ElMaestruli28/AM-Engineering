  ...
  const cardsData = [
    {
      ...
      subtitulo: 'Desarrollo y Puesta a Punto de Vehiculos de Competición',
    },
    {
      imagen: Img2,
      titulo: 'Coaching para pilotos y equipos',
      subtitulo: 'Mejora del Rendimiento y Análisis de Videos On Board',
    },
    {
      imagen: Img3,
      titulo: 'Servicios de Telemetría',
      subtitulo: 'Medición y Modificación en Tiempo Real',
    },
  ];
